        ...
        <nav className="absolute w-full border-gray-200 px-2 sm:px-4 py-2.5  bg-gray-900">
            <div className="container flex flex-wrap items-center justify-between mx-auto">
                ...
                <div className="flex md:order-2">
                    <button type="button" className="text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">Logout</button>
                ...
                <div className={`items-center justify-between ${open ? '' : 'hidden'} w-full md:flex md:w-auto md:order-1" id="navbar-cta`}>
                    <ul className="flex flex-col p-4 mt-4 border  rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md: bg-gray-800 md:bg-gray-900 border-gray-700">
                        {Menus.map((x, index) => (
